package org.lsposed.lspollution.model;
...
public class ResourcesMapping {
    ...
    private final Map<String, String> resourcesNameToIdMapping = new HashMap<>();
    private final Map<String, String> resourcesPathToIdMapping = new HashMap<>();
